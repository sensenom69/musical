...
$obj_llistat = $local->cargaRelacionConDatos(($_POST["tabla"]),$ordre["camp"],$ordre["ordre"],$condicions,$_POST["desde"],$elements_x_pagina);
$num_objectes = $local->numeroElementosRelacion(($_POST["tabla"]),"id",$condicions);
